...
| As a User |  I can view a list of posts so that I can select them                                                :white_check_mark: |
| As a User |  I can register an account so that I can comment, like and make reservations.                        :white_check_mark: |


* Admin 

| As a Admin | I can directly create reservations so that I can book a place.                                      :white_check_mark: |
|------------|-----------------------------------------------------------------------------------------------------------|
| As a Admin | I can create, read, update and delete posts so that I can manage my blog content                    :white_check_mark: |
| As a Admin | I can approve or disapprove reservations so that I can make sure we are not overbooked              :white_check_mark: |
| As a Admin | I can approve or disapprove comments so that I can filter out inappropriate comments.               :white_check_mark: |
